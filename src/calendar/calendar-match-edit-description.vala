namespace BobLauncher {
    namespace Calendar {
        private class EditCalendarEventDescription : ActionTarget {
            private unowned Plugin plg;
            private string calendar_name;
            private string calendar_color;

            public override string get_title() {
                return "Change event description";
            }

            public override string get_description() {
                return "Edit the description of this event";
            }
            ...
            internal EditCalendarEventDescription(Plugin _plg, string cal_name, string color) {
                Object();
                plg = _plg;
            ...
            public override bool do_execute(Match source, Match? target = null) {
                ...
                string new_description = helper.summary;
                ...
                bool success = calendar.update_event(
                    ...
                    null,
                    null,
                    new_description.strip().length > 0 ? new_description : "",
                    null
                );
